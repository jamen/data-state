# Contributing to data-state

First and foremost, thank you! We appreciate that you want to contribute to data-state, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for data-state**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for data-state:

- star the [project](https://github.com/jamen/data-state)
- tweet your support for data-state
...
- **version**: please note the version of data-state are you using
...
[so]: http://stackoverflow.com/questions/tagged/data-state